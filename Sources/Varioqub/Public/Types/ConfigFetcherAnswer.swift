...
public enum ConfigFetcherAnswer {
    ...
    /// Returns true if the request is ``ConfigFetcherAnswer/success``.
    ...
    /// Returns true if the request is ``ConfigFetcherAnswer/throttled``.
    ...
    /// Returns true if the request is ``ConfigFetcherAnswer/cached``.
    ...
    /// Returns true if the request is ``ConfigFetcherAnswer/error(_:)``.
