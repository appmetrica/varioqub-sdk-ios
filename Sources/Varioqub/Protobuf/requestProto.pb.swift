...
struct PBRequest: @unchecked Sendable {
...
struct PBClientFeature: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension PBRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}id\0\u{3}user_id\0\u{3}client_features\0\u{3}sdk_version\0\u{1}platform\0\u{1}version\0\u{3}version_code\0\u{1}language\0\u{3}device_id\0\u{1}diagnostics\0\u{3}os_version\0\u{3}os_human_version\0\u{3}sdk_adapter_name\0\u{3}sdk_id_adapter_name\0\u{3}request_id\0\u{3}prev_request_id\0\u{3}current_activated_config_version\0\u{3}cached_resource_keys\0")
